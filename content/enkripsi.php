							...
							<div class="body">
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane fade in active" id="home">
										<form method="POST" action="index.php?page=encryp" enctype="multipart/form-data">
										<b>PlainText</b><br><br>
												<div class="row clearfix">
													<div class="col-sm-12" id="caesar">
														<form  action="caesar.php#caesar" method="get">
															...
															<div class="form-group">
																<div class="form-line" >
																	<input class="form-control" style="width:200px;" placeholder="Masukan Jumlah Deret..." name="jd_enkripsi" required></input>
																</div>
															</div>
															<b>Key Hill</b><br>
															<div class="form-group">
																	...
																	<table align="left">
                                                        <tr><td>
                                                        <input type="number" size="5" id="0"  value = "" required>
                                                        <input type="number" size="5" id="1"  value = "" required>
                                                        
                                                        
                                                        </td></tr><br/>
                                                        <tr><td>
                                                        <input type="number" size="5" id="5"  value = "" required>
                                                        <input type="number" size="5" id="6"  value = "" required>
